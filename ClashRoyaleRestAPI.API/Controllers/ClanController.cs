...
using ClashRoyaleRestAPI.Application.Clan.Commands.AddClan;
using ClashRoyaleRestAPI.Application.Clan.Commands.AddPlayerClan;
using ClashRoyaleRestAPI.Application.Clan.Commands.RemovePlayerClan;
using ClashRoyaleRestAPI.Application.Clan.Commands.UpdatePlayerRank;
using ClashRoyaleRestAPI.Application.Clan.Queries.GetAllClanByName;
using ClashRoyaleRestAPI.Application.Clan.Queries.GetAllPlayers;
using ClashRoyaleRestAPI.Application.Clan.Queries.GetClanAvailables;
using ClashRoyaleRestAPI.Application.Clan.Queries.GetClanByIdFullLoad;

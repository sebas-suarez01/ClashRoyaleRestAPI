...
using ClashRoyaleRestAPI.Application.Player.Commands.AddCard;
using ClashRoyaleRestAPI.Application.Player.Commands.UpdateAlias;
using ClashRoyaleRestAPI.Application.Player.Queries.GetAllCardOfPlayer;
using ClashRoyaleRestAPI.Application.Player.Queries.GetAllPlayerByAlias;
using ClashRoyaleRestAPI.Application.Player.Queries.GetPlayerByIdFullLoad;
